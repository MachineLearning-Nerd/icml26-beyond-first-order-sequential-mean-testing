...
Current verification begins at [Claim 2 — VERIFIED at the paper setting](#/current-claim-2), followed by the preserved [Claim 1 — VERIFIED](#/current-claim-1). Each current page exposes the exact contract, assumption audit, executable verifier, full raw output, independent checker, negative controls, fixed command, locked environment, and CPU/runtime provenance.
