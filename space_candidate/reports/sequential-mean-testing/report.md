...
Experiment lineage: [fixed-sample baseline](https://github.com/MachineLearning-Nerd/icml26-beyond-first-order-sequential-mean-testing/tree/audit/claim-1-frozen-judged-baseline), [calibrated stopping CLT](https://github.com/MachineLearning-Nerd/icml26-beyond-first-order-sequential-mean-testing/tree/audit/claim-2-stopping-time-clt), [decomposition and Anscombe](https://github.com/MachineLearning-Nerd/icml26-beyond-first-order-sequential-mean-testing/tree/audit/claim-3-decomposition-anscombe), [single-run intervals](https://github.com/MachineLearning-Nerd/icml26-beyond-first-order-sequential-mean-testing/tree/audit/claim-4-single-run-intervals), [DSSAT repair](https://github.com/MachineLearning-Nerd/icml26-beyond-first-order-sequential-mean-testing/tree/audit/claim-5-stopped-draw-evidence), and [accepted cumulative render](https://github.com/MachineLearning-Nerd/icml26-beyond-first-order-sequential-mean-testing/tree/release/concise-evidence-stream).
