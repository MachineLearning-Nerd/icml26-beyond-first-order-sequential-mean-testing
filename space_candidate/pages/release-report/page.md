...
Every row also exposes method, limitations, fixed command, lockfile, seeds, Git SHA, CPU/runtime, and verifier console on its canonical page. [Visibility audit details](evidence/release/visibility_matrix.md) and [blind-review records](evidence/release/red-team-round-2.md) are downloadable.
